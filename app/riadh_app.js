export default () => ({
    async init() {
        ...
        newStyle.appendChild(document.createTextNode("@font-face { font-family: \"Tajawal\"; src: url(\""+(chrome?.runtime?.getURL("/assets/Tajawal-Regular.ttf") ?? "/assets/Tajawal-Regular.ttf") +"\") format('truetype'); font-weight: 400; }"));
        newStyle.appendChild(document.createTextNode("@font-face { font-family: \"Tajawal\"; src: url(\""+(chrome?.runtime?.getURL("/assets/Tajawal-Medium.ttf") ?? "/assets/Tajawal-Medium.ttf") +"\") format('truetype'); font-weight: 500; }"));
        newStyle.appendChild(document.createTextNode("@font-face { font-family: \"Tajawal\"; src: url(\""+(chrome?.runtime?.getURL("/assets/Tajawal-Bold.ttf") ?? "/assets/Tajawal-Bold.ttf") +"\") format('truetype'); font-weight: 600; }"));
